    ...
    return (
        <div className="container mx-auto px-4 md:px-6 py-4">
                ...
                <div className="w-2/5 flex flex-col">
                    ...
                    <div className="w-full h-3/5 pb-4">
                        <img
                            ...
                            alt="Carousel 1"
                            className="w-full h-full rounded-lg overflow-hidden cursor-pointer hover:scale-103 transition-all duration-300 shadow-lg"
                        />
                    </div>
                    {/* bottom */}
                    <div className="w-full h-2/5 flex">
                        <img
                            ...
                            alt="Carousel 1"
                            className="w-1/2 mr-2 rounded-lg overflow-hidden cursor-pointer hover:scale-103 transition-all duration-300 shadow-lg"
                        />
                        <img
                            ...
                            alt="Carousel 1"
                            className="w-1/2 ml-2 rounded-lg overflow-hidden cursor-pointer hover:scale-103 transition-all duration-300 shadow-lg"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-5 gap-4 mt-4">
                ...
                <div className="card h-40 flex items-center justify-center rounded-xl text-2xl font-bold text-white bg-gradient-to-br from-green-300 to-emerald-400 hover:scale-103 transition-all duration-300 active:scale-95 cursor-pointer select-none shadow-lg">
                    图像视频
                </div>

                <div className="card h-40 flex items-center justify-center rounded-xl text-2xl font-bold text-white bg-gradient-to-br from-amber-300 to-orange-400 hover:scale-103 transition-all duration-300 active:scale-95 cursor-pointer select-none shadow-lg">
                    生产力
                </div>

                <div className="card h-40 flex items-center justify-center rounded-xl text-2xl font-bold text-white bg-gradient-to-br from-red-300 to-pink-400 hover:scale-103 transition-all duration-300 active:scale-95 cursor-pointer select-none shadow-lg">
                    游戏娱乐
                </div>

                <div className="card h-40 flex items-center justify-center rounded-xl text-2xl font-bold text-white bg-gradient-to-br from-purple-300 to-indigo-400 hover:scale-103 transition-all duration-300 active:scale-95 cursor-pointer select-none shadow-lg">
                    AI工具
                </div>
            </div>
            {/* 推荐应用 */}
            ...
            <div className="mt-4">
                ...
                <div className="grid grid-cols-3 gap-4 mt-4">
                    <div className="card h-40 flex items-center justify-center rounded-xl text-lg font-bold text-white bg-gradient-to-br from-blue-300 to-indigo-400 hover:scale-103 transition-all duration-300 active:scale-95 cursor-pointer select-none shadow-lg">
                        这些工具你还不知道？
                    </div>

                    <div className="card h-40 flex items-center justify-center rounded-xl text-lg font-bold text-white bg-gradient-to-br from-green-300 to-emerald-400 hover:scale-103 transition-all duration-300 active:scale-95 cursor-pointer select-none shadow-lg">
                        AI时代，你准备好了吗？
                    </div>

                    <div className="card h-40 flex items-center justify-center rounded-xl text-lg font-bold text-white bg-gradient-to-br from-amber-300 to-orange-400 hover:scale-103 transition-all duration-300 active:scale-95 cursor-pointer select-none shadow-lg">
                        提升生产力，从这里开始！
                    </div>
                </div>
            </div>
